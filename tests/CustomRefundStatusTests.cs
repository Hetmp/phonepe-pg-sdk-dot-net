...
[NonParallelizable]
[TestFixture]
public class CustomRefundStatusTests : BaseSetupWithOAuth
{
   ...
   private const string MerchantRefundId = "merchantRefundId";
    ...
    public async Task RefundStatus_Successful_StandardCheckout()
    {
        ...
        var mockRefundResponse = new
        {
            ...
            paymentDetails = new[]
            {
                new { paymentMode = "UPI_COLLECT", timestamp = 34234324 }
            }
        };
        ...
        var response = await customCheckoutClient.GetRefundStatus(refundId);
