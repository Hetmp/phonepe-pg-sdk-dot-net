...
[NonParallelizable]
[TestFixture]
public class TransactionTests : BaseSetupWithOAuth
{
    ...
    [Test, Order(1)]
    public async Task StandardCheckout_TransactionStatus_Successful()
    {
        OAuthSetup();
        ...
        var url = $"/checkout/v2/transaction/{transactionId}/status";
        ...
        var result = await standardCheckoutClient.GetTransactionStatus(transactionId);
    ...
    [Test, Order(2)]
    public void StandardCheckout_TransactionStatus_Failed_WrongId()
    {
        OAuthSetup();
        ...
        var ex = Assert.ThrowsAsync<BadRequest>(async () => await standardCheckoutClient.GetTransactionStatus(transactionId));
    ...
    [Test, Order(3)]
    public void StandardCheckout_TransactionStatus_Failed_ServerError()
    {
        OAuthSetup();
        ...
        var ex = Assert.ThrowsAsync<ServerError>(async () => await standardCheckoutClient.GetTransactionStatus(transactionId));
